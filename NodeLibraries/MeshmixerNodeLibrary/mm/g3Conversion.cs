...
namespace mm
{
    public static class g3Conversion
    {
        ...
        public static DMesh3 ConvertUnwrapToUVs(RemoteControl rc, out IndexedUVMesh UVSet, string mainName = "main")
        {
            ...
            UVSet = new IndexedUVMesh();
            UVSet.UVTriangles.resize(mainMesh.TriangleCount);
